(function() {
  ...
  } button,.whitetext,#tooltip,#topright-displays>span,#topleft-displays>span,input[type="text"] {
    color: #7d64c8;
  ...
  OWOP.elements.paletteBg.addEventListener('contextmenu',(e)=>e.preventDefault());
})();
